        ...
        <div class="grid grid-cols-4 gap-12">
            ...
            <div>
                ...
                <div class="flex space-x-4 mt-2">
                    <img src="images/facebook.png" class="w-6" alt="Facebook" />
                    <img src="images/twitter.png" class="w-6" alt="Twitter" />
                    <img src="images/instagram.png" class="w-6" alt="Instagram" />
                    <img src="images/linkedin.png" class="w-6" alt="LinkedIn" />
                </div>
            </div>
        </div>
