...
@section('content')
    ...
    <section class="text-center mt-12">
        ...
        <h1 class="text-4xl text-blue-700 font-bold mt-2">Report Found Item</h1>
    </section>

    <!-- Form Section -->
    <section class="flex justify-center mt-10 mb-16">
        <form class="w-[600px] border shadow px-8 py-10 rounded-md bg-white space-y-6" action="{{ route('found-items.store') }}" method="POST" enctype="multipart/form-data">
            @csrf   
            <!-- Item -->
