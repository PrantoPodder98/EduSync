    ...
    <section class="px-8 my-20 text-center">
        ...
        <div class="flex justify-center items-center space-x-8 mb-12">
            ...
            <a href="{{ route('found-items.create') }}"
                ...
                <span class="mr-2 text-lg font-medium">Report Found Item</span>
        ...
        <div id="deleteModal"
            ...
            <div class="bg-white rounded-2xl p-8 max-w-md w-full mx-4 transform scale-95 transition-transform duration-300"
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-3">Delete Found Item</h3>
...
@section('custom_js')
    <script>
        ...
        const itemsData = @json($foundItems->keyBy('id'));
        ...
        function openDeleteModal(itemId) {
            ...
            // Update form action
            deleteForm.action = `/found-items/${itemId}`;
        ...
        function updateModalContent(item) {
            ...
            document.getElementById('modalDate').textContent = new Date(item.found_date).toLocaleDateString('en-US', {
                year: 'numeric',
                month: 'short',
                day: 'numeric'
            });
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const searchForm = document.querySelector('form[action*="found-items"]');
