        ...
        <div class="w-1/2 bg-white flex items-center justify-center px-16">
            <div class="w-full max-w-md">
                ...
                <div class="flex justify-center mb-8">
                    <a href="{{ route('login') }}"
                        class="text-indigo-600 font-semibold border-b-2 border-indigo-600 px-4 py-2 focus:outline-none">Sign
                        In</a>
                    <a class="text-gray-400 px-4 py-2 focus:outline-none" href="{{ route('register') }}">Sign Up</a>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center space-x-2 text-sm">
                            <input type="checkbox" class="form-checkbox text-indigo-600" name="remember" {{ old('remember') ? 'checked' : '' }} id="remember_me">
                            <span>Remember me</span>
                        </label>
                        {{-- <a href="#" class="text-indigo-600 text-sm hover:underline">Forgot password?</a> --}}
                    </div>

                    <button type="submit"
                        class="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-2 rounded-lg">Login</button>
