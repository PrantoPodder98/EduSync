                    ...
                    @foreach ($cartItems as $item)
                        <div class="flex items-center mb-4">
                            <img src="{{ asset($item->secondHandProduct->images->first()->url ?? 'asset/frontend_asset/images/default.jpg') }}"
                                class="w-10 h-10 object-cover rounded mr-3" alt="{{ $item->secondHandProduct->name }}">
                            <div class="flex-1">
                                <div class="text-sm font-medium">{{ $item->secondHandProduct->name }}</div>
                                <small class="text-gray-500">{{ $item->secondHandProduct->brand }} -
                                    {{ $item->secondHandProduct->item_state }}</small>
                            </div>
